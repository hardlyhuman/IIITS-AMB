      ...
      <div class="row"style="background:#eee">
		...
		<div class="col-sm-3 col-md-2 sidebar"style="background:#eee">
          <ul class="nav nav-sidebar">
			...
			<li><a href="index.php?option=Students_assigned" title="Students assigned to you"style="color:#232323"><span class="glyphicon glyphicon-user"style="color:#232323"></span> Students assigned </a></li>	
