...
<div class="table-responsive">
  <table class="table">
	<tr  class="danger">
	 	<th colspan="8"><a title="Add New Instructor" href="index.php?option=add_student"><span class=" glyphicon glyphicon-plus-sign" style="color:black"></span></a></th>
	 </tr>
	<tr class="info">
		<th>Sr. No</th>
		<th>Name</th>
...
if( $pagi > 0 )
 {
         $last = $pagi - 2;
      echo "<a href = \"index.php?option=Student&pagi=$last\">Last 10 Records</a> |";
        echo "<a href = \"index.php?option=Student&pagi=$pagi\">Next 10 Records</a>";
